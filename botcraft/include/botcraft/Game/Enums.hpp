...
enum class Dimension { None = -2, Nether, Overworld, End };
#endif

enum class Difficulty { None = -1, Peaceful, Easy, Normal, Hard };
...
enum class GameType { None = -1, Survival, Creative, Adventure, Spectator };
...
enum class Hand { Main = 0, Off = 1 };

enum class TintType { None, Water, Redstone, Grass, Leaves };
